 ...
 */
export class NetMsg_PVEActivityInfo implements IHandle<GetActivityPveInfoReq, GetActivityPveInfoRsp> {
  /** 请求消息号：GET_ACTIVITY_PVE_INFO_REQ (10137) */
  readonly reqId: MESSAGE_ID = MESSAGE_ID.GET_ACTIVITY_PVE_INFO_REQ;
  /** 响应消息号：GET_ACTIVITY_PVE_INFO_RSP (10138) */
  readonly recId: MESSAGE_ID = MESSAGE_ID.GET_ACTIVITY_PVE_INFO_RSP;

  Handle(req: GetActivityPveInfoReq): GetActivityPveInfoRsp {
