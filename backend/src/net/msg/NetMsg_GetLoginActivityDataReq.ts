 ...
 * 注册：reqId=10340、recId=-1
 */
export class NetMsg_GetLoginActivityDataReq implements IHandle<PlayerInfoSimple, {}> {
  /** 请求消息号：GET_LOGIN_ACTIVITY_REQ (10340) */
  readonly reqId: MESSAGE_ID = MESSAGE_ID.GET_LOGIN_ACTIVITY_REQ;
  /** 响应消息号：-1 */
